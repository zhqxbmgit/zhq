 ...
 *
 * 行为:
 *  - 快速点一下(不滑动)    -> 抬起时发一次原键(如 B)的完整点击。单击延迟不变。
...
public class SlideButton extends VirtualControllerElement {
    ...
    private static final float SLIDE_UP_THRESHOLD_DP = 24f;    // 向上滑阈值
    private static final float SLIDE_DOWN_THRESHOLD_DP = 24f;  // 向下滑阈值
